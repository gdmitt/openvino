...
void CodegenConvert::SetUp() {
    ...
    auto constant = ngraph::opset1::Constant::create(inType, ngraph::Shape{}, {125});
    auto sub = std::make_shared<ngraph::opset1::Subtract>(pad, constant);
    auto slice = ngraph::builder::makeSlice(sub, {0}, {5}, {1}, {0}, inType);
